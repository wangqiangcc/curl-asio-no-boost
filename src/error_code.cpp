...
class curl_easy_error_category : public asio::error_category
{
public:
...
class curl_multi_error_category : public asio::error_category
{
public:
...
class curl_share_error_category : public asio::error_category
{
public:
...
class curl_form_error_category : public asio::error_category
{
public:
