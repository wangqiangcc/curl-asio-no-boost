...
namespace curl
{
	namespace errc
	{
		...
		const asio::error_category& get_easy_category();
		const asio::error_category& get_multi_category();
		const asio::error_category& get_share_category();
		const asio::error_category& get_form_category();
	}
}
...
namespace curl
{
	namespace errc
	{
		namespace easy
		{
			inline asio::error_code make_error_code(easy_error_codes e)
			{
				return asio::error_code(static_cast<int>(e), get_easy_category());
			}
		}

		namespace multi
		{
			inline asio::error_code make_error_code(multi_error_codes e)
			{
				return asio::error_code(static_cast<int>(e), get_multi_category());
			}
		}

		namespace share
		{
			inline asio::error_code make_error_code(share_error_codes e)
			{
				return asio::error_code(static_cast<int>(e), get_share_category());
			}
		}

		namespace form
		{
			inline asio::error_code make_error_code(form_error_codes e)
			{
				return asio::error_code(static_cast<int>(e), get_form_category());
			}
		}
	}
	...
	namespace native
	{
		inline asio::error_code make_error_code(CURLcode e)
		{
			return make_error_code(static_cast<errc::easy::easy_error_codes>(e));
		}

		inline asio::error_code make_error_code(CURLMcode e)
		{
			return make_error_code(static_cast<errc::multi::multi_error_codes>(e));
		}

		inline asio::error_code make_error_code(CURLSHcode e)
		{
			return make_error_code(static_cast<errc::share::share_error_codes>(e));
		}

		inline asio::error_code make_error_code(CURLFORMcode e)
		{
